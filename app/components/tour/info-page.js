...
class InfoPage extends Component{
  ...
  onPress(){
    ...
    // Alert.alert('SAFETY', '\n1) You must have a passenger to follow the directions as they appear on the screen.\n\n 2) If you miss a turn, use adjacent roads to navigate safely back to the instructed route.\n\n 3) Some locations have limited parking. Be cautious of your surroundings, and respect the specified parking directions.\n\n 4) Some markers are on private property. Be courteous to others, and be mindful of trespassing.\n\n 5) Drive safely. The developer, Chatham Township Historical Society, and contributors hold no liability for any incidents that may occur while using this app.'
    Alert.alert('SAFETY', '\n1) You MUST have a passenger to operate the app as you drive.\n\n 2) If you miss a turn, use adjacent roads to navigate safely back to the instructed route.\n\n 3) Some locations have limited parking. Be cautious of your surroundings, and respect the specified parking directions.\n\n 4) Some markers are on private property. Be courteous to others, and be mindful of trespassing.\n\n 5) Drive safely. The developer, Chatham Township Historical Society, and contributors hold no liability for any incidents that may occur while using this app.'
    ,[{ text: 'Ok, I Understand', onPress: () => this.permissionsPopup()},
    ]);
  }
